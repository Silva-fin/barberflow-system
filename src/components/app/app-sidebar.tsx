    ...
    items: [
      ...
      { title: "Caixa", url: "/caixa", icon: Receipt, roles: ["OWNER", "ADMIN", "OPERATOR"] },
      {
        ...
        children: [
          ...
          { title: "Extrato", url: "/financeiro/extrato", roles: ["OWNER", "ADMIN", "OPERATOR"] },
        ],
      },
      { title: "Despesas", url: "/despesas", icon: FileSpreadsheet, roles: ["OWNER", "ADMIN", "OPERATOR"] },
      {
        title: "Estoque",
        url: "/estoque",
        icon: Warehouse,
        roles: ["OWNER", "ADMIN", "OPERATOR"],
        children: [
          { title: "Produtos", url: "/estoque", roles: ["OWNER", "ADMIN", "OPERATOR"] },
          { title: "Movimentações", url: "/estoque/movimentacoes", roles: ["OWNER", "ADMIN", "OPERATOR"] },
        ],
      },
